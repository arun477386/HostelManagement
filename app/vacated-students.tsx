...
export default function VacatedStudentsScreen() {
  ...
  const [vacatedStudents, setVacatedStudents] = React.useState<any[]>([]);
  ...
  React.useEffect(() => {
    const fetchVacatedStudents = async () => {
      try {
        ...
        setVacatedStudents(allStudents);
      } catch (error: any) {
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No vacated students found</Text>
          </View>
        )}
      />
    </View>
